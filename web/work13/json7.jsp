            ...
            $.ajax({
                ...
                success:function(data, status){
                    ...
                    for(var i in jsonInfo.books){
                        memberInfo += jsonInfo.books[i].title + "<br/>";
                        memberInfo += jsonInfo.books[i].writer + "<br/>";
                        memberInfo += jsonInfo.books[i].price + "<br/>";
                        memberInfo += jsonInfo.books[i].genre + "<br/>";
                        memberInfo += '<img src="' + jsonInfo.books[i].image + '" ' +
                            'alt="'+jsonInfo.books[i].title+'"/><br/><br/><br/>';
                    }
